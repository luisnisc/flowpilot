      ...
      <div className="m-auto w-full max-w-md p-8 rounded-xl shadow-xl bg-white">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-600">
            Únete a FlowPilot y empieza a gestionar tus proyectos
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full py-3 mt-6 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium transition-colors duration-300 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 cursor-pointer"
            disabled={loading}
          >
