...
export default function Home() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("ScrollSmoother error:", error);
    }
  }, []);
        ...
        <div ref={contentRef} className="smooth-content">
          ...
          <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-blue-900 via-blue-800 to-blue-900 text-white">
            ...
            <div className="container mx-auto px-6 z-20 text-center">
              ...
              >
                FlowPilot optimiza el flujo de trabajo de tu equipo con
                herramientas intuitivas para la gestión de proyectos en tiempo
                real.
              </motion.p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16">
                <div className="space-y-12">
                  <AnimatedSection>
                    ...
                    <p className="text-gray-600 mb-6">
                      Organiza y visualiza las tareas de tu equipo con una
                      interfaz drag-and-drop que facilita el seguimiento del
                      progreso.
                    </p>
                  </AnimatedSection>
                ...
                <div className="space-y-12 mt-12 lg:mt-24">
                  <AnimatedSection delay={0.2}>
                    ...
                    <p className="text-gray-600 mb-6">
                      Visualiza el estado de tus proyectos y tareas en un panel
                      de control intuitivo y personalizable según tus
                      necesidades.
                    </p>
                  </AnimatedSection>
                  <ParallaxImage
            ...
            <div className="container mx-auto px-6">
              <div className="text-center mb-16">
                <AnimatedSection>
                  ...
                  <p className="text-gray-600 max-w-2xl mx-auto">
                    Descubre cómo FlowPilot está ayudando a equipos de todo tipo
                    a mejorar su productividad y gestión de proyectos.
                  </p>
                </AnimatedSection>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <AnimatedSection delay={0.2}>
                  <div className="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <p className="text-gray-600">
                      "Desde que implementamos FlowPilot, hemos reducido en un
                      40% el tiempo dedicado a la gestión de tareas. La
                      visualización de Kanban es simplemente perfecta."
                    </p>
                  </div>
                </AnimatedSection>
                ...
                <AnimatedSection delay={0.3}>
                  <div className="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <p className="text-gray-600">
                      ...
                      gracias a FlowPilot. La capacidad de ver quién está
                      trabajando en qué tarea en tiempo real ha eliminado la
              ...
              <div className="text-center">
                <AnimatedSection>
                  <h2 className="text-3xl sm:text-4xl font-bold mb-6">
                    ¿Listo para llevar tu gestión de proyectos al siguiente
                    nivel?
                  </h2>
                  <p className="text-xl max-w-2xl mx-auto mb-8 text-blue-100">
                    Únete a los equipos que ya están optimizando su flujo de
                    trabajo con FlowPilot.
                  </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
                <div className="md:col-span-4">
                  ...
                  <p className="text-blue-100 mb-6">
                    Solución avanzada para la gestión de proyectos en tiempo
                    real. Optimiza el flujo de trabajo de tu equipo con
              ...
              <div className="border-t border-blue-800/50 mt-12 pt-8">
                <div className="flex flex-col md:flex-row justify-between items-center">
                  ...
                  <p className="text-blue-300 text-sm">
                    &copy; {new Date().getFullYear()} FlowPilot. Todos los
                    derechos reservados.
                  </p>
                </div>
              </div>
